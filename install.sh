...
sudo update-alternatives --install /usr/bin/jar jar /usr/lib/jvm/jdk-17.0.1/bin/jar 1
...
sudo update-alternatives --set jar /usr/lib/jvm/jdk-17.0.1/bin/jar
...
cat > jdk-17.0.1.sh << EOF
export J2SDKDIR=/usr/lib/jvm/jdk-17.0.1
export J2REDIR=/usr/lib/jvm/jdk-17.0.1
export PATH=\$PATH:/usr/lib/jvm/jdk-17.0.1/bin
export JAVA_HOME=/usr/lib/jvm/jdk-17.0.1
export DERBY_HOME=/usr/lib/jvm/jdk-17.0.1
EOF

source /etc/profile.d/jdk-17.0.1.sh
